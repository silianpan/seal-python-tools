...
class Handler(BaseHandler):
    ...
    def __init__(self):
        self.spider_config = {
            "source_url": 'https://shuidian.bjx.com.cn',
            'urls': [
                {'url': '/yw', 'classify': 'yw', 'classify_name': u'要闻', 'industry': u'水电'},
                {'url': '/sc', 'classify': 'sc', 'classify_name': u'市场', 'industry': u'水电'},
                {'url': '/bg', 'classify': 'bg', 'classify_name': u'报告', 'industry': u'水电'},
                {'url': '/sj', 'classify': 'sj', 'classify_name': u'数据', 'industry': u'水电'},
                {'url': '/zc', 'classify': 'zc', 'classify_name': u'政策', 'industry': u'水电'},
                {'url': '/pl', 'classify': 'pl', 'classify_name': u'评论', 'industry': u'水电'},
                {'url': '/bd', 'classify': 'bd', 'classify_name': u'报道', 'industry': u'水电'},
                {'url': '/hy', 'classify': 'hy', 'classify_name': u'会议', 'industry': u'水电'},
                {'url': '/gj', 'classify': 'gj', 'classify_name': u'国际', 'industry': u'水电'},
                {'url': '/bz', 'classify': 'bz', 'classify_name': u'标准', 'industry': u'水电'},
            ],
            'db': {
                'host': '39.98.39.58',
                'user': 'root',
    ...
    def detail_page(self, response):
        content = response.doc('.cc-article')
        if not content:
            return
